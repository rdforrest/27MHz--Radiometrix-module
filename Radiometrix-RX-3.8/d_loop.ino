void loop()
{
  ...
  if (currentMillis - previousMillis >= interval) {
    ...
    buffer[0] = 160;  // Rudder - slight turn
    buffer[1] = 127;  // Planes - neutral
    buffer[2] = 127;  // Set to Neutral
    buffer[3] = 127;  // Set to Neutral
    buffer[4] = 10;   // Piston tank to empty
    buffer[5] = 127;  // Speed control - neutral
    buffer[6] = 123;  // 123 in TX ident shows failsafe
